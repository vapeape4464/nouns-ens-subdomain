...
abstract contract AbstractSubdomainRegistrar is ISubdomainRegistrar {
    // namehash('eth')
    bytes32 public constant TLD_NODE = 0x93cdeb708b7545dc668eb9280176169d1c33cfd8ed6f04690a0bcc88a93fc4ae;
    ...
    function isSubdomainAvailable(bytes32 _label, string calldata _subdomain) external view override returns (bool) {
    ...
    function owner(bytes32 _label) public view virtual returns (address);
